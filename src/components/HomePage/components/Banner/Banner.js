        ...
        <div className={classes.rowBetween}>
            <div className={classes.left}>
                ...
                <div className={classes.contentText}>
                    <span className={classes.text}>  Ứng dụng hỗ trợ bạn ra quyết định đầu tư tốt nhất với  giải pháp BlueStar Rating - ĐỘC QUYỀN và DUY NHẤT tại Việt Nam gồm 6 tiêu chí lớn và 36 tiêu chí con theo tiêu chuẩn quốc tế đã được đăng ký sở hữu trí tuệ.</span>
                    {/* <br/>
